# DRAFT - Angular Boot Camp Curriculum - sanitization
...
[StackBlitz for sanitization](https://stackblitz.io/github/AngularBootCamp/sanitization)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/sanitization.git
cd sanitization
yarn
yarn start
```
